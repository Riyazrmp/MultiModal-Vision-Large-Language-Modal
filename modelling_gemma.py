...
import math
from model_siglip import VisionEncoderConfig, VisionModel
...
class TextDecoderTransformerConfig():
    def __init__(
        self,
        vocab_size,
        hidden_size,
...
class VLMConfig():
    def __init__(
        ...
        **kwargs,
        ...
        self.text_config = TextDecoderTransformerConfig(**text_config, pad_token_id=pad_token_id)
...
class MultiHeadAttention(nn.Module):
    def __init__(self, config: TextDecoderTransformerConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class DecoderLayer(nn.Module):
    def __init__(self, config: TextDecoderTransformerConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = MultiHeadAttention(config=config, layer_idx=layer_idx)
...
class Model(nn.Module):
    def __init__(self, config: TextDecoderTransformerConfig):
        super().__init__()
        self.config = config
...
class VLMConditionalGeneration(nn.Module):
    def __init__(self, config: VLMConfig):
        super().__init__()
        self.config = config
        ...
        language_model = CausalVLM(config.text_config)
